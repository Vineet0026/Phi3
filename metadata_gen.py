...
md = [{
    ...
    "abstract": (
        "The probability distributions for bending angles in double helical DNA obtained in all-atom molecular dynamics "
        "simulations are compared with theoretical predictions. For double helices of one helical turn and longer, the computed "
        "distributions remarkably agree with the worm-like chain theory and qualitatively differ from predictions of the semi-elastic "
        "chain model. The computed data exhibit only small anomalies in the apparent flexibility of short DNA and cannot account for "
        "the recently reported AFM data. It is possible that current atomistic DNA models miss some essential mechanisms of DNA bending "
        "on intermediate length scales. Analysis of bent DNA structures reveals that the bending motion is structurally heterogeneous "
        "and directionally anisotropic on the intermediate length scales where the experimental anomalies were detected. These effects "
        "are essential for the interpretation of the experimental data and they also can be responsible for the apparent discrepancy."
    ),
    "keywords": [
    ...
    "arxiv_id": "arXiv:0704.3948v1 [q-bio.BM]",
    "results": (
        "The probability distributions of bend angles in DNA fragments obtained from the MD simulations show a remarkable agreement "
        "with the WLC theory, particularly for DNA segments of 1-2 helical turns. The distributions deviate from the SEC model predictions, "
        "suggesting that the SEC critical length may be smaller than previously thought. The study identifies heterogeneity in DNA bending "
        "properties and directionality, which may account for discrepancies between MD simulations and experimental AFM data."
    )
},{
    "title": "Cosmology and semi-conservation of computations in the universe",
    "author": "Vadim Astakhov",
    "abstract": "Resent works of Hawking and Susskind suggested that information is conserved in the universe. We extend this thesis and propose that dynamics of information - computations can conserve in Anti-de-Sitter cosmological model. Information geometry formalism is proposed to analyze information in dynamical systems. We consider entropy flow as a geometrical flow on statistical manifold and develop a Dynamic Cores model to analyze migration of information in dynamical systems. Geometrical flow on the statistical manifold was considered as a transition of local dynamical systems in original d+1-dim AdS space to their delocalized holographic representation in d-dim Conformal Field Theory (CFT). It was noted that geometrical flow related to renormalization group flow and provide semi-conservation of informational invariants. Those invariants interpreted as types of computations.",
    "keywords": ["computation", "information conservation", "information geometry", "dynamical system", "dynamic core"],
    "publication_date": "N/A",
    "arxiv_id": "N/A",
    "results": "The paper proposes a hypothesis that computations in the universe can be semi-conserved in an Anti-de-Sitter cosmological model. It introduces a Dynamic Cores model for analyzing the migration of information in dynamical systems and uses information geometry to represent these processes. The study suggests that entropy flow on a statistical manifold relates to renormalization group flow, providing semi-conservation of informational invariants, which are interpreted as types of computations. The formalism presented can serve as a physical model for emergent dualism or qualified monism, suggesting computations generated through physical processes can survive by migrating to another physical host."
},{
    "title": "Reconstructing weak values without weak measurements",
    "author": ["Lars M. Johansen"],
    "abstract": "I propose a scheme for reconstructing the weak value of an observable without the need for weak measurements. The post-selection in weak measurements is replaced by an initial projector measurement. The observable can be measured using any form of interaction, including projective measurements. The reconstruction is effected by measuring the change in the expectation value of the observable due to the projector measurement. The weak value may take nonclassical values if the projector measurement disturbs the expectation value of the observable.",
    "keywords": ["Weak values", "projective measurements", "projection postulate", "nonclassicality", "weak measurements"],
    "publication_date": "2018-10-29",
    "arxiv_id": "0705.0108v1",
    "results": [
        "Proposed a new scheme for reconstructing weak values without using weak measurements.",
        "Demonstrated that weak values can be reconstructed from an initial projector measurement followed by a measurement of the observable.",
        "Showed that this method can use any form of interaction, including projective measurements.",
        "Established that nonclassical weak values are directly related to finite measurement disturbance."
    ]
},{
    "title": "Kinematic Decoupling of Globular Clusters with Extended Horizontal-Branch",
    "author": "Young-Wook Lee, Hansung B. Gim, Dana I. Casetti-Dinescu",
...
,{
    ...
    'arxiv_id': 'arXiv:0704.0682v1 [astro-ph]',
    'results': [
        'Confirmation of previous findings in other oxygen-rich envelopes regarding SiO maser emission distributions.',
        'Identification of distinct spatial distributions between 43 GHz and 86 GHz SiO maser lines in R Leo.',
        'Observational support for discrepancies between observed maser line distributions and theoretical predictions in AGB stars.',
        'Advancement in understanding maser pumping mechanisms through multi-line and multi-epoch VLBI observations.',
        'Importance of line overlaps in SiO maser pumping mechanisms highlighted, impacting theoretical models.'
    ]
},
{
    'title': 'A search for OH 6 GHz maser emission towards southern supernova remnants',
    'author': [
        'Korinne E. McDonnell',
        'Alan E. Vaughan',
        'Mark Wardle'
    ...
    'arxiv_id': 'arXiv:0704.2271v1',
    'results': [
        'No 6049 MHz maser emission was found in the survey.',
        'Three new sites of 6035 MHz and 6030 MHz OH maser emission were discovered in star-forming regions.',
        'The 6035 MHz maser at 48.98-0.30 is approximately coincident with two H II regions.',
        'Further analysis may yield weaker 6 GHz masers.',
        'Data from ATCA observations of seventeen supernova remnants remain to be analyzed.'
    ]
}
,{
    'title': 'Quantitative Resolution to some "Absolute Discrepancies" in Cancer Theories: a View from Phage lambda Genetic Switch',
    'author': ['Ping Ao'],
    'abstract': 'Is it possible to understand cancer? Or more specifically, is it possible to understand cancer from genetic side? There already many answers in literature. The most optimistic one has claimed that it is mission-possible. Duesberg and his colleagues reviewed the impressive amount of research results on cancer accumulated over 100 years. It confirms the a general opinion that considering all available experimental results and clinical observations there is no cancer theory without major difficulties, including the prevailing gene-based cancer theories. They have then listed 9 ”absolute discrepancies” for such cancer theory. In this letter the quantitative evidence against one of their major reasons for dismissing mutation cancer theory, by both in vivo experiment and a first prin- ciple computation, is explicitly pointed out.',
    'keywords': [
        'cancer theories',
        'mutation theory',
    ...
    'arxiv_id': 'arXiv:0704.0429v1 [q-bio.SC] 3 Apr 2007',
    'results': [
        'Quantitative evidence provided against the dismissal of mutation cancer theory based on in vivo experiments and first principle computations.',
        'Discussion of 9 "absolute discrepancies" in cancer theories proposed by Duesberg et al.',
        'Explanation of how mutations can alter phenotypes at rates exceeding conventional gene mutations by 4-11 orders of magnitude, using Phage lambda genetic switch as an example.',
        'Relevance of findings to understanding the genetic basis of cancer and implications for future research.'
    ]
}
,{
    ...
    "arxiv_id": None,
    "results": [
        "The Euler-Heisenberg effective Lagrangian and its role in QED and Primakoff",
        "Quantum electrodynamics and the vacuum birefringence",
        "Astrophysical constraints on axion particle masses",
        "Photon-photon interactions and axion-like particles",
...
data_str = json.dumps(md , cls=SetEncoder)
